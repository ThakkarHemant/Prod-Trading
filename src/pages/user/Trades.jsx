  ...
  return (
    <div className="space-y-4 sm:space-y-6 p-4 sm:p-6">
      ...
      <div>
        ...
        <p className="text-gray-500 text-sm sm:text-base">Manage your trading positions</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="card">
          <div className="card-header p-4 sm:p-6">
            <h3 className="card-title text-lg sm:text-xl">All Trades</h3>
            <p className="card-description text-sm sm:text-base">Your complete trading history</p>
          </div>
              ...
              <div className="hidden sm:block">
                <div className="min-w-[1000px]">
                  <table className="table w-full">
                    <thead>
                      <tr>
                        <th className="min-w-[150px] text-left">Instrument</th>
                        <th className="min-w-[80px] text-center">Type</th>
                        <th className="min-w-[90px] text-center">Status</th>
                        <th className="min-w-[90px] text-right">Quantity</th>
                        <th className="min-w-[100px] text-right">Entry Price</th>
                        <th className="min-w-[150px] text-center">Entry Date</th>
                      </tr>
                    </thead>
                    <tbody>
                      {filteredTrades.length === 0 ? (
                        ...
                        filteredTrades.map(trade => (
                          <tr key={trade.trade_id}>
                            ...
                            <td className="text-right">${trade.price?.toFixed(2) || 'N/A'}</td>
                            <td className="text-center text-sm">{formatDate(trade.timestamp)}</td>
                          </tr>
                        ))
                      )}
                    </tbody>
