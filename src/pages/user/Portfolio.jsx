  ...
  if (error) {
    return (
      <div className="text-center p-8">
        ...
        <div className="text-sm bg-red-50 p-4 rounded-lg mb-4">
          {error}
        </div>
        <button 
          onClick={() => window.location.reload()}
    ...
    <div className="p-4 lg:p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4 mb-6">
        ...
        <div className="text-left lg:text-right">
          <div className="text-xl lg:text-2xl font-bold">🪙{coin_balance ?? 0} coins</div>
          ...
          <table className="w-full min-w-[700px]">
            <thead className="bg-gray-50 sticky top-0">
              <tr>
                ...
                <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Current Price</th>
                <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Value</th>
                <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">P&L</th>
                <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Return %</th>
                <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Trades</th>
              </tr>
            </thead>
