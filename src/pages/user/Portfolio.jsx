                    ...
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="border-b">
                          ...
                          <th className="text-left p-2 font-medium">Current Price</th>
                      ...
                      <tbody>
                        {renderTableRows(currentHoldings)}
                      </tbody>
                    </table>
                  </div>
                </TabsContent>
